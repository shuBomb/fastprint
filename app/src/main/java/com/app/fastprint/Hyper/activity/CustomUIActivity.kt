...
class CustomUIActivity : BasePaymentActivity(), ITransactionListener {
    ...
    private var consumerKeyString: String = "";
    private var consumerSecretString: String = "";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        consumerKeyString = intent.getStringExtra("consumerKey").toString()
        consumerSecretString = intent.getStringExtra("consumerSecret").toString()
    ...
    private fun initViews() {
        ...
        button_pay_now.setOnClickListener {
            if (paymentProvider != null && checkFields()) {
                requestCheckoutId(orderId,amount,currency,consumerKeyString,consumerSecretString)
            }
        }
    }
