...
public class MPageGramAdapter extends RecyclerView.Adapter<MPageGramAdapter.ViewHolder> {
    ...
    public MPageGramAdapter(Context context, List<String> paperGramList) {
