...
//        });
    ...
    protected void onResume() {
        super.onResume();
        if(AppControler.getInstance().getString(AppControler.Key.ISDROPBOXFile_SELECTED)=="1"){
            Intent data = new Intent();
            data.putExtra("SelectedDropBoxFile",AppControler.getInstance().getDropBoxSelectedFile());
    ...
    private void downloadFile(FileMetadata file) {
        ...
        new DownloadFileTask(FilesActivity.this, DropboxClientFactory.getClient(), new DownloadFileTask.Callback() {
            ...
            public void onDownloadComplete(File result) {
                ...
                if (result != null) {
                    Intent data = new Intent();
                    data.putExtra("SelectedDropBoxFile",result);
                    AppControler.getInstance().selectedDropBoxFile(result);
                    AppControler.getInstance().put(AppControler.Key.ISDROPBOXFile_SELECTED,"1");
