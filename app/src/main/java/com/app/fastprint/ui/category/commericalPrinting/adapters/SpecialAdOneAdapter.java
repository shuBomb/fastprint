...
public class SpecialAdOneAdapter extends RecyclerView.Adapter<SpecialAdOneAdapter.ViewHolder> {
    ...
    public SpecialAdOneAdapter(Context context, ArrayList<Model> categoryModelArrayList, CommercialPrintingActivity commercialPrintingActivity) {
