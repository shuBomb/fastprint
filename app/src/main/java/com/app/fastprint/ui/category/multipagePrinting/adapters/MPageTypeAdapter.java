...
public class MPageTypeAdapter extends RecyclerView.Adapter<MPageTypeAdapter.ViewHolder> {
    ...
    public MPageTypeAdapter(Context context, List<String> paperTypeList) {
